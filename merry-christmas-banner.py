...
def drawStocking():
    ...
    unicornhathd.set_pixel(4, 3, 255, 255, 255)
    ...
    unicornhathd.set_pixel(4, 11, 255, 0, 0)
    ...
    unicornhathd.set_pixel(3, 13, 255, 0, 0)
    unicornhathd.set_pixel(4, 13, 255, 0, 0)
    unicornhathd.set_pixel(5, 13, 255, 0, 0)
    unicornhathd.set_pixel(6, 13, 255, 0, 0)
    unicornhathd.set_pixel(7, 13, 255, 0, 0)
    unicornhathd.set_pixel(8, 13, 255, 0, 0)
    unicornhathd.set_pixel(9, 13, 255, 0, 0)

    unicornhathd.set_pixel(4, 14, 255, 0, 0)
    unicornhathd.set_pixel(5, 14, 255, 0, 0)
    unicornhathd.set_pixel(6, 14, 255, 0, 0)
    unicornhathd.set_pixel(7, 14, 255, 0, 0)
